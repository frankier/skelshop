...
STRATEGIES = {
    "simple-face3": (pick_best_faces_face3, "openpose-face3"),
    "simple-face5": (pick_best_faces_face5, "openpose-face5"),
    "simple-face68": (pick_best_faces_face68, "openpose-face68"),
...
def bestcands(skelin, segsout, strategy):
    ...
    with open(segsout, "w") as outf, h5py.File(skelin, "r") as skel_h5f:
        ...
        for seg_idx, shot in enumerate(skel_read):
            for frame_num, pers_id in strat_fn(shot):
